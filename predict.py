...
prediction_row = (stock_data.groupby("Symbol").tail(1).copy())
...
# %%
def stockTraining (stock_name):

    stock_df = stock_data[stock_data["Symbol"]==stock_name].copy()
...
if __name__ == "__main__":
    ...
    result = stockTraining(stock_name)
